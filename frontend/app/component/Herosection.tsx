...
const Herosection : React.FC<HerosectionProps> = ({ className}) => {
  return (
    ...
    <section  className={`hero-section ${className} flex flex-wrap font-mono max-w-screen-xl px-4 py-8 pt-20 mx-auto md:flex lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 align-center justify-center`}>
       
       <div className="text-center md:text-left mr-auto place-self-center lg:col-span-7 ">
            <h1 className="max-w-2xl mb-4 text-4xl font-extrabold tracking-tight leading-none md:pt-20 md:text-5xl xl:text-6xl ">Thioline gou Yiw ak <span className='text-cyan-400'>Maraxib</span> Store </h1>
            ...
            <button className="bg-black text-white py-4 px-6 rounded-full flex items-center animate-bounce md:mx-0">
